...
---
### Books
[soldierx](https://entropy.soldierx.com/~kayin/archive/), this archive contains some kind of old looking hacking PDFs and TXTs. (2010) and a lot more, for example exploits
...
[please dont hack me](https://please.dont-hack.me/books/hacking/), is just another HUGE collection of programming and cyber security books, publicly available.
...
[Kontra](https://application.security/), this site has some very cool graphical showcases of vulnerabilities, most are paid, but there are some free ones.
...
---
[Linux Reversing Beginners](https://osandamalith.com/2019/02/11/linux-reverse-engineering-ctfs-for-beginners/), on this site you can find a short guide on reverse engineering Linux programs, aimed at CTF challenges.
...
[malwareunicorn](https://malwareunicorn.org/#/), a website with a lot of tutorials on reversing, it even includes costume VMs!
...
[VX Heaven](https://vxug.fakedoma.in/archive/VxHeaven/lib/), I am not completely sure what this website is, but it's about malware development and has some very cool articles.
...
## Games / labs
---
[XSS Game](https://xss-game.appspot.com/), is a game about finding XSS vulnerabilities. It has hints, and you can also view the code of your target to analyze it and find vulnurabilites. It has 6 levels so it's not that long.
...
[HackTheBox](https://www.hackthebox.eu/), ah yes, one of the biggest platforms when it comes to hacking labs and such. It's an amazing platform, with a lot of rooms, challenges and an amazing community.
...
[Hackthissite](https://hackthissite.org/), this is a very cool website where you can learn of basic website hacking, they even have a challenge where you can try to hack the actual website itself! It is very fun to try hack through more and more levels.

[PicoCTF](https://www.picoctf.org/), is a very beginner friendly CTF platform, with mostly CTFs that are easy and you just have to download a file for them for example. It's great for setting you up for real CTF chellanges, they even have their own CTF even once a year!

[Ringzer0 ctf](https://ringzer0ctf.com/), this site has a lot of CTF chellanges too, as of writing 358 chellanges are up to play.

[vulnhub](https://www.vulnhub.com/), this one is a little different, you can download vulnerable VMs here and try exploiting them, but you don't do this online, because they don't have to use as much bandwidth, this platform offers free rooms. A lot of them.

[DVWA](https://dvwa.co.uk/), Damn Vulnerable Web Application is a single server that you can run with a LOT of vulnerabilities, so you can try yourself at exploiting as much as you can find.
